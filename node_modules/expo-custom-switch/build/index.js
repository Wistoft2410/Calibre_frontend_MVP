...
export default function Switch({ onChange, style, value, iconLeft, iconRight, leftColor, rightColor, ...props }) {
    ...
    return (<TouchableOpacity accessibilityRole="button" tabIndex={0} activeOpacity={1.0} {...props} {...onEnterAndClick(onValueChange)} style={[styles.wrapper, style]}>
      <CustomSwitch isClicked={value} iconLeft={iconLeft} iconRight={iconRight} leftColor={leftColor} rightColor={rightColor}/>
    </TouchableOpacity>);
}
const createAnimatedValue = (isOn) => React.useRef(new Animated.Value(isOn ? 1 : 0));
const SlideUpIcon = ({ isClicked, ...props }) => {
    ...
    return (<Animated.View style={[
      ...
      <Icon name="archive" {...props} style={[styles.icon, props.style]}/>
...
const CustomSwitch = ({ isClicked, iconLeft, iconRight, leftColor, rightColor, }) => {
    ...
    return (<Animated.View ref={ref} style={[
      ...
      <Circle isClicked={isClicked} iconLeft={iconLeft} iconRight={iconRight} leftColor={leftColor} rightColor={rightColor}/>
    </Animated.View>);
};
const Circle = ({ isClicked, iconLeft, iconRight, leftColor, rightColor, ...props }) => {
    const ref = React.useRef(null);
    const value = createAnimatedValue(isClicked);
    React.useEffect(() => {
        Animated.timing(value.current, {
