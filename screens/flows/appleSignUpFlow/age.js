...
import {BACKGROUND, RADIUS, COLOR, Neumorphism, Container, ActionContainer, HeroContainer, ProgressBar, DropDown, Swipe} from "../../../components/Style";
    ...
    return(
      <Container>
        ...
        <View style={[ActionContainer.actionContainerSignUp, ActionContainer.actionContainerSignUpAvoiding]}>
          <View style={Swipe.swipeBackHintContent}>
              <Text style={Swipe.swipeBackHintText}>
